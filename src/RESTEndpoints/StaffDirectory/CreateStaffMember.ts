...
import { STAFF_DIRECTORY_DATABASE, STAFF_DIRECTORY_PERMISSION_SCOPE } from '../../Utils/constants';
...
export const GetGame = {
  ...
  run: async (req, res, next, user) => {
    ...
    const staffMember = {
      ...
      pfp: !!req.body.pfp && typeof req.body.pfp == "string" ? typeof req.body.pfp : null,
      description: !!req.body.description && typeof req.body.description == "string" ? typeof req.body.description : null,
      schedule,
    };
